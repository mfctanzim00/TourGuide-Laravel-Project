...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Toastr::success('Your post is successfully submitted! Admin will review it. Thank you!', 'success');
    ...
    public function update(Request $request, $id)
    {
        ...
        Toastr::success('Post Successfully Updated. Admin will review it', 'success');
    ...
    public function likedUsers($post) {
        $post = Post::find($post);
        return view('user.post.likedUsers', compact('post'));
    }
}
